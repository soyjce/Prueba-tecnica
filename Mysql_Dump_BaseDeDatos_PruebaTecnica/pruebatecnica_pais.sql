...
CREATE TABLE `pais` (
  ...
  `idzonahoraria` bigint(20) NOT NULL,
  PRIMARY KEY (`idpais`),
  KEY `FKtf3px2swfl90a5hkqecrbbajk` (`idzonahoraria`),
  CONSTRAINT `FKtf3px2swfl90a5hkqecrbbajk` FOREIGN KEY (`idzonahoraria`) REFERENCES `zonahoraria` (`idzonahoraria`)

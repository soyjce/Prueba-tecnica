...
CREATE TABLE `estado` (
  ...
  KEY `FKeia8okcb69i6cx509jvolrj8y` (`idpais`),
  CONSTRAINT `FKeia8okcb69i6cx509jvolrj8y` FOREIGN KEY (`idpais`) REFERENCES `pais` (`idpais`)
...
INSERT INTO `estado` VALUES (1,'Bogotá',1);

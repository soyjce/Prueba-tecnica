...
CREATE TABLE `estudiante` (
  ...
  KEY `FK73xrewnqyja3mjpva141u2v86` (`idciudad`),
  CONSTRAINT `FK73xrewnqyja3mjpva141u2v86` FOREIGN KEY (`idciudad`) REFERENCES `ciudad` (`idciudad`)
...
INSERT INTO `estudiante` VALUES (1,36,'Peinol Cleta Perez',1);

...
CREATE TABLE `pregunta` (
  ...
  KEY `FKi6m985dxpxeana4cfvhyifu01` (`idexamen`),
  CONSTRAINT `FKi6m985dxpxeana4cfvhyifu01` FOREIGN KEY (`idexamen`) REFERENCES `examen` (`idexamen`)
...
INSERT INTO `pregunta` VALUES (1,'Pregunta 1',1),(2,'Pregunta 2',1);

...
CREATE TABLE `ciudad` (
  ...
  KEY `FKkng8gs5jlsyfrktfvbta6di2i` (`idestado`),
  CONSTRAINT `FKkng8gs5jlsyfrktfvbta6di2i` FOREIGN KEY (`idestado`) REFERENCES `estado` (`idestado`)
...
INSERT INTO `ciudad` VALUES (1,'Bogotá',1);
